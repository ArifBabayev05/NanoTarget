...
Canlı sayt: **https://nanotarget-mvp.vercel.app**
Vercel layihəsi: `arif-babayev-projs/nanotarget-mvp`
...
- Turso resursu `nanotarget-db` Vercel Marketplace-dən yaradılıb, layihəyə bağlıdır (`TURSO_DATABASE_URL`, `TURSO_AUTH_TOKEN` production/preview/development). Dashboard: Vercel → Storage.
...
- WebAuthn RP id = host (`nanotarget-mvp.vercel.app`); passkey bu domenə bağlıdır.
